create or replace package unit_test is
  ...
  */
  ...
  /**
  * «апуск тестов
  * @param  p_pack_nm  наименование пакета дл¤ поиска
  * @param  p_test_nm  наименование процедуры теста внутри пакеета дл¤ поиска
  * если параметры не указаны то будут выполн¤тьс¤ все тесты
  */
...
create or replace package body unit_test is
  ...
  */
  ...
  /**
  * «апись результата в лог
  * @param p_result  код результата
  * @param p_message сообщение теста
  * @param p_addition дополнительна¤ информаци¤
  */
  ...
  /**
  * ѕолучить список тестов на схеме
  * @param  p_pack_nm  наименование пакета дл¤ поиска
  * @param  p_test_nm  наименование процедуры теста внутри пакеета дл¤ поиска
  ...
  */
  ...
  /**
  * «апуск на выполнение массива тестов
  * @param  p_pack_nm  наименование пакета дл¤ поиска
  * @param  p_test_nm  наименование процедуры теста внутри пакеета дл¤ поиска
  * если параметры не указаны то будут выполн¤тьс¤ все тесты
  */
